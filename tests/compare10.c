...
#define OUTFILE  "compare10.out"
#define THISFILE "compare10"
...
void c_char_gte_lit1(unsigned char expected_result)
{
  ...
  {
/*    LOG_ERROR(1); */
    fprintf(outfile,"c_char_gte_lit1: char %02x - result %02x expected: %02x\n",char0,result,expected_result);
    failures++;
  }

/*  fprintf(outfile,"char %02x - %02x failures: %d\n",char0,expected_result,failures); */
